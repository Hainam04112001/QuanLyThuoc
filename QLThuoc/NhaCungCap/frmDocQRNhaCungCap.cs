...
{
    public partial class frmDocQRNhaCungCap : Form
    {
        FilterInfoCollection filterInfoCollection;
        VideoCaptureDevice videoCaptureDevice;
        public frmDocQRNhaCungCap()
        {
            InitializeComponent();
        }

        private void frmDocQRNhaCungCap_Load(object sender, EventArgs e)
        {
        ...
        private void frmDocQRNhaCungCap_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (pictureBox1.Image != null)
            {
                ...
                if (result != null)
                {
                    ...
                    if (videoCaptureDevice.IsRunning)
                        videoCaptureDevice.Stop();
                    QLThuoc.NhaCungCap1.frmXemNhaCungCap xemNhaCungCap = new QLThuoc.NhaCungCap1.frmXemNhaCungCap(int.Parse(txt_kq.Text));
                    xemNhaCungCap.ShowDialog();
                }
            }
        }
