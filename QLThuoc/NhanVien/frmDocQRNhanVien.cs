...
{
    public partial class frmDocQRNhanVien : Form
    {
        FilterInfoCollection filterInfoCollection;
        VideoCaptureDevice videoCaptureDevice;
        public frmDocQRNhanVien()
        {
            InitializeComponent();
        }

        private void frmDocQRNhanVien_Load(object sender, EventArgs e)
        {
        ...
        private void frmDocQRNhanVien_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (pictureBox1.Image != null)
            {
                ...
                if (result != null)
                {
                    ...
                    if (videoCaptureDevice.IsRunning)
                        videoCaptureDevice.Stop();
                    QLThuoc.NhanVien1.frmXemNhanVien xemNhanVien = new QLThuoc.NhanVien1.frmXemNhanVien(int.Parse(txt_kq.Text));
                    xemNhanVien.ShowDialog();
                }
            }
        }
