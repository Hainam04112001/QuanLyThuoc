...
{
    public partial class frmDocQRDonThuoc : Form
    {
        FilterInfoCollection filterInfoCollection;
        VideoCaptureDevice videoCaptureDevice;
        public frmDocQRDonThuoc()
        {
            InitializeComponent();
        }
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (pictureBox1.Image != null)
            {
                ...
                if (result != null)
                {
                    ...
                    if (videoCaptureDevice.IsRunning)
                        videoCaptureDevice.Stop();
                    QLThuoc.DonThuoc1.frmXemDonThuoc frmXemDonThuoc = new DonThuoc1.frmXemDonThuoc(int.Parse(txt_kq.Text));
                    frmXemDonThuoc.ShowDialog();
                }
            }
        }
