...
namespace QLThuoc.DonThuoc1
{
    public partial class frmXemCTDonThuoc : Form
    {
        ...
        public void ThemSp()
        {
            ...
            dsdt.Add(sp);
            MessageBox.Show("Số lượng sản phẩm: " + dsdt.Count().ToString(),"Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
            loadLuoi();
        }
        ...
        private void dgv_Thongtin_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if(e.ColumnIndex == 0)
            {
                ...
                MessageBox.Show("Xóa", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                loadLuoi();
