...
{
    public partial class frmDocQRLoaiThuoc : Form
    {
        FilterInfoCollection filterInfoCollection;
        VideoCaptureDevice videoCaptureDevice;
        public frmDocQRLoaiThuoc()
        {
            InitializeComponent();
        }

        private void frmDocQRLoaiThuoc_Load(object sender, EventArgs e)
        {
        ...
        private void frmDocQRLoaiThuoc_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (pictureBox1.Image != null)
            {
                ...
                if (result != null)
                {
                    ...
                    if (videoCaptureDevice.IsRunning)
                        videoCaptureDevice.Stop();
                    QLThuoc.LoaiThuoc1.frmXemLoaiThuoc xemLoaiThuoc = new QLThuoc.LoaiThuoc1.frmXemLoaiThuoc(int.Parse(txt_kq.Text));
                    xemLoaiThuoc.ShowDialog();
                }
            }
        }
